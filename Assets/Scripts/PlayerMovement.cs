...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Set isFalling to true if the player's velocity is less than -40
        bool isFalling = yVelocity < -40;
        anim.SetBool("isFalling", isFalling);

        // Clamp yVelocity so it never goes below -41
        yVelocity = Mathf.Max(yVelocity, -41);
